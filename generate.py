...
def generate_wav(
        data, gen_dir='./results', base='sample', sptk_dir='/u/kumarrit/world.py/merlin/tools/bin/SPTK-3.9/', world_dir='/u/kumarrit/world.py/merlin/tools/bin/WORLD/', norm_info_file='/data/lisa/exp/kumarrit/vctk/norm_info_mgc_lf0_vuv_bap_63_MVN.dat',
